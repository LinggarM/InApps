...
class CompletedOrderFragment : Fragment() {
    ...
    private lateinit var rvCompletedRental: RecyclerView
    private lateinit var rvCompletedDesain: RecyclerView
    private lateinit var rvCompletedCetak: RecyclerView
    private lateinit var rvCompletedInstall: RecyclerView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvCompletedRental = view.findViewById(R.id.rv_completed_rental)
        rvCompletedDesain = view.findViewById(R.id.rv_completed_desain)
        rvCompletedCetak = view.findViewById(R.id.rv_completed_cetak)
        rvCompletedInstall = view.findViewById(R.id.rv_completed_install)

        db = Firebase.firestore
        accountSessionPreferences = AccountSessionPreferences(requireContext())

        val statusList: MutableList<Long> = ArrayList<Long>()
        statusList.add(2)
        statusList.add(3)
        ...
        db.collection("orders_rental")
            ...
            .addOnSuccessListener { documents ->
                ...
                if (rentalList.size > 0) {
                    ...
                    rvCompletedRental.visibility = View.VISIBLE

                    // Show Recycler View
                    rvCompletedRental.layoutManager = LinearLayoutManager(context)
                    val ordersRentalAdapter = OrdersRentalAdapter(rentalList)
                    rvCompletedRental.adapter = ordersRentalAdapter
        ...
        db.collection("orders_desain")
            ...
            .addOnSuccessListener { documents ->
                ...
                if (desainList.size > 0) {
                    ...
                    rvCompletedDesain.visibility = View.VISIBLE

                    // Show Recycler View
                    rvCompletedDesain.layoutManager = LinearLayoutManager(context)
                    val ordersDesainAdapter = OrdersDesainAdapter(desainList)
                    rvCompletedDesain.adapter = ordersDesainAdapter
        ...
        db.collection("orders_cetak")
            ...
            .addOnSuccessListener { documents ->
                ...
                if (cetakList.size > 0) {
                    ...
                    rvCompletedCetak.visibility = View.VISIBLE

                    // Show Recycler View
                    rvCompletedCetak.layoutManager = LinearLayoutManager(context)
                    val ordersCetakAdapter = OrdersCetakAdapter(cetakList)
                    rvCompletedCetak.adapter = ordersCetakAdapter
        ...
        db.collection("orders_install")
            ...
            .addOnSuccessListener { documents ->
                ...
                if (installList.size > 0) {
                    ...
                    rvCompletedInstall.visibility = View.VISIBLE

                    // Show Recycler View
                    rvCompletedInstall.layoutManager = LinearLayoutManager(context)
                    val ordersInstallAdapeter = OrdersInstallAdapter(installList)
                    rvCompletedInstall.adapter = ordersInstallAdapeter
