...
class OrderedFragment : Fragment() {
    ...
    private lateinit var rvOrderedCetak: RecyclerView
    private lateinit var rvOrderedInstall: RecyclerView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvOrderedCetak = view.findViewById(R.id.rv_ordered_cetak)
        rvOrderedInstall = view.findViewById(R.id.rv_ordered_install)
