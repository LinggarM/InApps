...
class PosterActivity : AppCompatActivity() {
    ...
    private val product: String = "202"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvDeskripsi.text = resources.getString(R.string.deskripsi_poster)
            ...
            if (deskripsi_desain == "") {
                ...
                builder.apply {
                    setPositiveButton("Yes") { dialogInterface, i ->
                        ...
                        Tools.showToastAddtoCart(this@PosterActivity, layoutInflater, product)
                        finish()
                    }
