...
class CoCardActivity : AppCompatActivity() {
    ...
    private val product: String = "303"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvDeskripsi.text = resources.getString(R.string.deskripsi_cocard_cetak)
            ...
            if (urlFileDesain == "") {
                ...
                builder.apply {
                    setPositiveButton("Yes") { dialogInterface, i ->
                        ...
                        Tools.showToastAddtoCart(this@CoCardActivity, layoutInflater, product)
                        finish()
                    }
