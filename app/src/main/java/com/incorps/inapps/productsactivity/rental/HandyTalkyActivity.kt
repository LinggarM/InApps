...
class HandyTalkyActivity : AppCompatActivity() {
    ...
    private val product: String = "105"
                ...
                if (qty == 0) {
                    ...
                    builder.apply {
                        setPositiveButton("Yes") { dialogInterface, i ->
                            ...
                            Tools.showToastAddtoCart(this@HandyTalkyActivity, layoutInflater, product)
                            finish()
                        }
    ...
    private fun tabsDeskripsi() {
        tvDeskripsi.text = resources.getString(R.string.deskripsi_handy_talky)
