...
class DesainKemasanActivity : AppCompatActivity() {
    ...
    private val product: String = "208"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvDeskripsi.text = resources.getString(R.string.deskripsi_desainkemasan)
            ...
            if (deskripsi_desain == "") {
                ...
                builder.apply {
                    setPositiveButton("Yes") { dialogInterface, i ->
                        ...
                        Tools.showToastAddtoCart(this@DesainKemasanActivity, layoutInflater, product)
                        finish()
                    }
