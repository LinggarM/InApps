...
import com.incorps.inapps.productsactivity.rental.ProyektorAtasTigaRibuActivity
...
class BannerActivity : AppCompatActivity() {
    ...
    private val product: String = "201"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvDeskripsi.text = resources.getString(R.string.deskripsi_banner)
            ...
            if (deskripsi_desain == "") {
                ...
                builder.apply {
                    setPositiveButton("Yes") { dialogInterface, i ->
                        ...
                        Tools.showToastAddtoCart(this@BannerActivity, layoutInflater, product)
                        finish()
                    }
