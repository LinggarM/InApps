...
class PlakatKayuActivity : AppCompatActivity() {
    ...
    private val product: String = "302"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvDeskripsi.text = resources.getString(R.string.deskripsi_plakatkayu_cetak)
            ...
            if (urlFileDesain == "") {
                ...
                builder.apply {
                    setPositiveButton("Yes") { dialogInterface, i ->
                        ...
                        Tools.showToastAddtoCart(this@PlakatKayuActivity, layoutInflater, product)
                        finish()
                    }
