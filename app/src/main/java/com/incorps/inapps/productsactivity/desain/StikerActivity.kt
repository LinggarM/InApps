...
class StikerActivity : AppCompatActivity() {
    ...
    private val product: String = "204"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvDeskripsi.text = resources.getString(R.string.deskripsi_stiker)
            ...
            if (deskripsi_desain == "") {
                ...
                builder.apply {
                    setPositiveButton("Yes") { dialogInterface, i ->
                        ...
                        Tools.showToastAddtoCart(this@StikerActivity, layoutInflater, product)
                        finish()
                    }
