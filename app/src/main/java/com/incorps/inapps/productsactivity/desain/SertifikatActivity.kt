...
class SertifikatActivity : AppCompatActivity() {
    ...
    private val product: String = "206"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvDeskripsi.text = resources.getString(R.string.deskripsi_sertifikat)
            ...
            if (deskripsi_desain == "") {
                ...
                builder.apply {
                    setPositiveButton("Yes") { dialogInterface, i ->
                        ...
                        Tools.showToastAddtoCart(this@SertifikatActivity, layoutInflater, product)
                        finish()
                    }
