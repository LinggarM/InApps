...
class ScreenProyektorActivity : AppCompatActivity() {
    ...
    private val product: String = "103"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnTimeDatePeminjaman.setOnClickListener {
            ...
            } else if (editHariPeminjaman.text.toString().toInt() <= 0) {
        ...
        btnFotoIdentitas.setOnClickListener {
            ...
            startActivityForResult(
                Intent.createChooser(pickFile, "Select Picture"),
                PICK_IMAGE
            )
        }
                ...
                if (qty == 0) {
                    ...
                    builder.apply {
                        setPositiveButton("Yes") { dialogInterface, i ->
                            ...
                            Tools.showToastAddtoCart(this@ScreenProyektorActivity, layoutInflater, product)
                            finish()
                        }
    ...
    private fun tabsDeskripsi() {
        tvDeskripsi.text = resources.getString(R.string.deskripsi_screen_proyektor)

        btnSpesifikasi.visibility = View.INVISIBLE
        btnHarga.visibility = View.INVISIBLE
    ...
    private fun setSpinnerLamaPeminjaman() {
        layoutLamaPeminjaman.visibility = View.GONE
        updatePrice()
    }
