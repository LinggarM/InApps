...
class PlakatActivity : AppCompatActivity() {
    ...
    private val product: String = "207"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvDeskripsi.text = resources.getString(R.string.deskripsi_plakat)
            ...
            if (deskripsi_desain == "") {
                ...
                builder.apply {
                    setPositiveButton("Yes") { dialogInterface, i ->
                        ...
                        Tools.showToastAddtoCart(this@PlakatActivity, layoutInflater, product)
                        finish()
                    }
