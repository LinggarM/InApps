...
class PointerActivity : AppCompatActivity() {
    ...
    private val product: String = "104"
                ...
                if (qty == 0) {
                    ...
                    builder.apply {
                        setPositiveButton("Yes") { dialogInterface, i ->
                            ...
                            Tools.showToastAddtoCart(this@PointerActivity, layoutInflater, product)
                            finish()
                        }
    ...
    private fun tabsDeskripsi() {
        tvDeskripsi.text = resources.getString(R.string.deskripsi_pointer)
